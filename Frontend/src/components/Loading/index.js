...
export default function Loading() {
  ...
  const loadingEventList = useSelector(
    (state) => state.eventReducer.loadingEventList
  );
  const loadingGetListSeat = useSelector(
    (state) => state.BookTicketReducer.loadingGetListSeat
  );
  const loadingEventDetailShowtimes = useSelector(
    (state) => state.eventDetailReducer.loadingEventDetailShowtimes
  );
  const loading =
    isLazy ||
    loadingEventList ||
    loadingGetListSeat ||
    loadingEventDetailShowtimes ||
    isLoadingBackToHome;
